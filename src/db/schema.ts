...
export const userRelations = relations(users, ({ many }) => ({
  ...
  subscriptions: many(subscriptions, {
    relationName: "subscriptions_creator_id_fkey", // 与 subscriptions 的 creator 关联匹配
  }),
  subscribers: many(subscriptions, {
    relationName: "subscriptions_viewer_id_fkey", // 与 subscriptions 的 creator 关联匹配
  }),
...
export const commentRelations = relations(comments, ({ one, many }) => ({
  ...
  origin: one(comments, {
    fields: [comments.originId],
    references: [comments.id],
    relationName: "comments_origin_id_fkey",
  }),
  reactions: many(commentReactions),
  replies: many(comments, {
    relationName: "comments_parent_id_fkey",
  }),
  originReplies: many(comments, {
    relationName: "comments_origin_id_fkey",
  }),
}));
